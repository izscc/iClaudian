...
export class AntigravityCommandCatalog implements ProviderCommandCatalog {
  ...
  async saveVaultEntry(): Promise<void> { throw new Error('Antigravity runtime commands are not editable from iClaudian.'); }
  async deleteVaultEntry(): Promise<void> { throw new Error('Antigravity runtime commands are not deletable from iClaudian.'); }
