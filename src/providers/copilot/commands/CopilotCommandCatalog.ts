...
export class CopilotCommandCatalog implements ProviderCommandCatalog {
  ...
  async saveVaultEntry(): Promise<void> { throw new Error('Copilot runtime commands are not editable from iClaudian.'); }
  async deleteVaultEntry(): Promise<void> { throw new Error('Copilot runtime commands are not deletable from iClaudian.'); }
