...
export class OpencodeAgentSettings {
  ...
  async render(): Promise<void> {
    ...
    headerEl.createSpan({ text: t('settings.opencode.subagents.name' as any), cls: 'claudian-sp-label' });
    ...
    if (visibleAgents.length === 0) {
      ...
      emptyEl.setText(t('settings.opencode.subagentsExtra.empty' as any));
      return;
    }
